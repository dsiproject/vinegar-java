...
/**
 * Composable type-specific encoding-decoding functions.  Lenses are
 * based loosely on the work of Pierce et. al., and on the various
 * research projects that have grown up around that work.
 */
